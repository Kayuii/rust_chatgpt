...
class NativeWire implements FlutterRustBridgeWireBase {
  ...
  void wire_get_helleworld(
    int port_,
  ) {
    return _wire_get_helleworld(
      port_,
    );
  }

  late final _wire_get_helleworldPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>(
          'wire_get_helleworld');
  late final _wire_get_helleworld =
      _wire_get_helleworldPtr.asFunction<void Function(int)>();
