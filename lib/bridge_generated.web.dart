...
class NativeWasmModule implements WasmModule {
  ...
  external dynamic /* void */ wire_start_global_event_stream(
      NativePortType port_, String app_type);

  external dynamic /* void */ wire_stop_global_event_stream(
      NativePortType port_, String app_type);

  external dynamic /* void */ wire_get_helleworld(NativePortType port_);
}
...
class NativeWire extends FlutterRustBridgeWasmWireBase<NativeWasmModule> {
  ...
  void wire_start_global_event_stream(NativePortType port_, String app_type) =>
      wasmModule.wire_start_global_event_stream(port_, app_type);

  void wire_stop_global_event_stream(NativePortType port_, String app_type) =>
      wasmModule.wire_stop_global_event_stream(port_, app_type);

  void wire_get_helleworld(NativePortType port_) =>
      wasmModule.wire_get_helleworld(port_);
}
